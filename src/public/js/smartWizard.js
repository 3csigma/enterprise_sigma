...
(function (factory) {
  ...
  var defaults = {
    ...
    toolbarSettings: {
      ...
      // show/hide a Guardar button
      showSubmitButton: true,
      // show/hide a Submit button
  ...
  var SmartWizard = /*#__PURE__*/function () {
    ...
    _createClass(SmartWizard, [{
      ...
      value: function _setEvents() {
        ...
        this.main.find('.sw-btn-guardar').on("click", function (e) {
          e.preventDefault();

          _this._showGuardar();
        }); // Keyboard navigation event

        this.main.find('.sw-btn-submit').on("click", function (e) {
          e.preventDefault();
      ...
      value: function _createToolbar(position) {
        ...
        var btnGuardar = this.options.toolbarSettings.showGuardarButton !== false ? $('<button></button>').text(this.options.lang.guardar).addClass('btn btn-primary sw-btn-guardar').attr('type', 'button') : null;
        var btnSubmit = this.options.toolbarSettings.showSubmitButton !== false ? $('<button></button>').text(this.options.lang.submit).addClass('btn btn-primary sw-btn-submit').attr('type', 'button') : null;
        toolbar.append(btnPrevious, btnNext, btnGuardar, btnSubmit); // Add extra toolbar buttons
      ...
      key: "_showGuardar",
      value: function _showGuardar() {
        var si = this._getGuardarShowable(this.current_index);
      ...
      key: "_showSubmit",
      value: function _showSubmit() {
        var si = this._getSubmitShowable(this.current_index);
      ...
      key: "_getGuardarShowable",
      value: function _getGuardarShowable(idx) {
        var si = false; // Find the next showable step
      ...
      key: "_getSubmitShowable",
      value: function _getSubmitShowable(idx) {
        var si = false; // Find the next showable step
        ...
        if (!this.options.cycleSteps) {
          ...
          switch (this._getStepPosition(idx)) {
            ...
            default:
              ...
              if (this._getGuardarShowable(idx) === false) {
                this.main.find('.sw-btn-guardar').css('display', 'block');
              }
              if (this._getSubmitShowable(idx) === false) {
                this.main.find('.sw-btn-submit').css('display', 'block');
              }
              break;
          }
