...
const rutasAdmin = ['consultores', 'actualizarconsultor', 'bloquearconsultor', 'actualizarempresa', 'bloquearempresa', 'pagomanual-diagnostico', 'pagomanual-empresas', 'cancelarsub', 'recursos-compartidos']
