const rutasEmpresa = ['logout', 'perfil', 'updateprofile', 'actualizarfotoperfil', 'create-payment-intent', 'diagnostico-de-negocio', 'ficha-cliente', 'addficha', 'eliminarficha', 'acuerdo-de-confidencialidad', 'analisis-de-negocio', 'guardar-archivos-analisis', 'plan-empresarial', 'plan-estrategico', 'editartarea', 'pagar-diagnostico', 'pagar-analisis', 'pagar-analisis-per1','pagar-analisis-per2', 'pagar-analisis-per3', 'pagar-empresarial', 'pagar-empresarial-per1','pagar-empresarial-per2', 'pagar-empresarial-per3', , 'pagar-plan-estrategico', 'pago-cancelado', 'pago-exitoso', 'guardar-archivos-analisis', 'guardar-archivos-empresariales', 'guardar-archivos-estrategico', 'cuestionario-diagnostico', 'diagnostico-proyecto', 'generar-informe', 'informe-estrategico', 'guardar-grupo', 'eliminarcampo', 'eliminargrupo','actualizarrecurso','eliminarrecurso','enviar-archivo','cargar-link','recursos', 'copiar-recurso', 'editar-categoria', 'mis-modulos', 'leccion-completada', 'modulo-completado']

const rutasConsultor = ['logout', 'perfil', 'updateprofile', 'actualizarfotoperfil', 'comentariotareas', 'empresas', 'empresas-asignadas', 'enviar-propuesta-empresa', 'analisis-dimension-producto', 'analisis-dimension-administracion', 'analisis-dimension-operaciones', 'analisis-dimension-marketing', 'agregartarea', 'editartarea', 'actualizartarea', 'eliminartarea', 'nuevorendimiento', 'cuestionario-diagnostico', 'diagnostico-proyecto', 'guardarinforme', 'conclusiones', 'guardar-archivos-empresarial', 'website-empresarial', 'finalizaretapa', 'solicitar-archivos-empresa', 'eliminar-archivos-empresa', 'agregartarea-consultores','generar-informe', 'actualizarRecurso']

const rutasAdmin = ['consultores', 'actualizarconsultor', 'bloquearconsultor', 'actualizarempresa', 'bloquearempresa', 'pagomanual-diagnostico', 'pagomanual-empresas', 'cancelarsub', 'recursos-compartidos', 'add-grupos-compartidos', 'eliminargrupo', 'eliminarcampo', 'eliminargrupo','actualizarrecurso','eliminarrecurso','enviar-archivo','cargar-link', 'guardar-grupo','ver-modulos','crear-modulos','guardar-modulo', 'eliminar-modulo', 'updatecategory', 'editar-modulo', 'subir-archivos', 'actualizar-modulo', 'actualizar-leccion', 'agregar-leccion', 'consultar-lecciones', 'eliminar-leccion', 'actualizar-estado-modulo', 'actualizar-orden-lecciones']
